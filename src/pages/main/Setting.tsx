...
import { SunMoon, Globe, Users, ShieldCheck, Trash2, ExternalLink, Monitor, Mic } from "lucide-react";
        ...
        <div style={{ display: "flex", flexDirection: "column", height: "100%", padding: "0 16px 16px" }}>
            <div>
                <div className="settings-list">
                    ...
                    {isDev && (
                        <button className="settings-item" onClick={() => navigate("/main/setting/embedded-webview?src=/test_audio.html")}>
                            <span className="settings-left">
                                <Mic className="settings-icon" aria-hidden="true" strokeWidth={1.8} />
                                <span className="label">{t("settings.test_audio")}</span>
                            </span>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                <polyline points="9 18 15 12 9 6" />
                            </svg>
                    ...
                    {isDev && (
                        <button className="settings-item" onClick={() => navigate("/audio-smoke") }>
                            <span className="settings-left">
                                <Mic className="settings-icon" aria-hidden="true" strokeWidth={1.8} />
                                <span className="label">{t("settings.audio_smoke")}</span>
                            </span>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                <polyline points="9 18 15 12 9 6" />
                            </svg>
