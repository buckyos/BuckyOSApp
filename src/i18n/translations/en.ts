export default {
    common: {
        ...
        creating: "Creating account and binding SN...",
    ...
    import: {
        ...
        subtitle: "Enter the mnemonic phrase and password. The app will query SN by public key first, and only accounts with an existing SN record can be imported.",
        auto_name_hint: "You do not need to enter a name manually. If an SN record is found, the app will automatically use the name on SN as the local display name for this account.",
    ...
    tray: {
        ...
        status: {
            running_single: "BuckyOS Desktop Service is running on this device.",
            running_cluster: "BuckyOS local services on this device are running. This does not represent the full cluster status.",
            stopped_single: "BuckyOS Desktop Service on this device is stopped. Local BuckyOS services are unavailable.",
            stopped_cluster: "BuckyOS local services on this device are stopped.",
            error_single: "BuckyOS Desktop Service on this device is not running normally. Configuration expects it to be running, but the health check did not pass.",
            error_cluster: "BuckyOS local services on this device are not running normally. Configuration expects them to be running, but the health check did not pass.",
        ...
        confirm: {
            ...
            start_message_single: "This will start the single-device BuckyOS Desktop Service on this machine. Continue?",
            start_message_cluster: "This will start the BuckyOS local services on this device only. It will not affect any other device. Continue?",
            start_continue: "Start",
            stop_title: "Stop local services",
            stop_message_single: "This device runs the single-device BuckyOS Desktop Service. After stopping, BuckyOS services on this device will be unavailable. Continue?",
            stop_message_cluster: "This will only stop the BuckyOS local services on this device. It will not stop the BuckyOS cluster. Continue?",
            stop_continue: "Stop",
            restart_title: "Restart local services",
            restart_message_single: "This will restart the single-device BuckyOS Desktop Service. Local services will be briefly unavailable. Continue?",
            restart_message_cluster: "This will restart the BuckyOS local services on this device only. It will not affect any other device. Continue?",
