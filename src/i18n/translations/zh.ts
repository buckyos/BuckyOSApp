export default {
    ...
    sn: {
        ...
        username_ok: "用户名可用，绑定后可以通过 https://{{username}}.buckyos.ai 访问您的 zone 内服务",
        ...
        bind_password_message: "请输入密码以生成配置并绑定 SN",
        bind_password_placeholder: "请输入密码",
        retry: "重试",
        error: {
            query_failed: "查询 SN 失败：{{message}}",
            check_username_failed: "检查用户名失败，请重试。",
            check_invite_failed: "检查邀请码失败，请重试。",
            zone_config_failed: "生成配置失败：{{message}}",
